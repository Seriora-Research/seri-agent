...
reviewer-verifier runs in a separate context. Verified live (`stage-4-checkpoints`, 2026-08-04):
...
reviewer could not verify a single VERIFY-phase claim from the repository and had only the
