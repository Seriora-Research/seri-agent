...
Probe the execution environment and write a complete `.cursor/loops/<slug>/environment.md`
using `.cursor/templates/environment.md` as the template. Fill every section — do not leave
...
Write the result to `.cursor/loops/<slug>/environment.md` and return the path.
