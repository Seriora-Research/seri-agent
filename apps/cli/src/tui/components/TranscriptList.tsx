...
const TranscriptRow = memo(function TranscriptRow({
  ...
  if (entry.kind === "file-change" && entry.fileChange !== undefined) {
    return <FileChangeBlock change={entry.fileChange} gap={gap} />;
  }
